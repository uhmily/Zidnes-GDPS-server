...
//stuff
$chest1stuff = (rand(intdiv($chest1minOrbs, 100), intdiv($chest1maxOrbs, 100))*100).",".rand($chest1minDiamonds, $chest1maxDiamonds).",".$chest1items[array_rand($chest1items)].",".rand($chest1minKeys, $chest1maxKeys)."";
$chest2stuff = (rand(intdiv($chest2minOrbs, 100), intdiv($chest2maxOrbs, 100))*100).",".rand($chest2minDiamonds, $chest2maxDiamonds).",".$chest2items[array_rand($chest2items)].",".rand($chest2minKeys, $chest2maxKeys)."";
